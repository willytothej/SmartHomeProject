...
<br /><br /><br />
  ...
  <tr>
    <td><label for="name">Registration Number</label> </td>
    <td><p class="name"> 
		     
        <input type="number" name="ConfirmCode" id="ConfirmCode" required/> 
...
?>
	...
	contentType: "application/json",
         url: "http://www.fluidityhome.me/api/User/CreateCarer.php",
		data:{"Password": Password,          "RegType": "1",                       "ConfirmCode": ConfirmCode                  ,"LastName": Second,           "UserName": Username,            "FirstName": First,        "EmailAddress": Email },
...
if(obj[0].Username === "1"){
	...
	$( "#Errorr" ).append( "<p>Username taken</p>" );
		...
		if(obj[0].Username === "0"&& obj[0].Email === "0" && obj[0].Code === "1"){
